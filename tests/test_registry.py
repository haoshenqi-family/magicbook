...
class TestSeedDefaultConfig:
    ...
    def test_seed_creates_deepseek_provider_row(self, app, ai_session):
        ...
        prov = ai_session.query(AiProvider).filter_by(provider_name="deepseek").first()
